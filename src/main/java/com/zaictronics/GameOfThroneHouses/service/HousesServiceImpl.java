...
//        houseModel.setId(urlFormatter.formatUrl(houseDTO.getUrl()));
    ...
    @Override
    public ResponseEntity<List<MiniHouseModel>> getHouseByTittles(String reqParam) {

        houseRepository.setKey(utilWords.getBooleanParamKey().get("hasTitles"));
        return getListResponseEntity(reqParam);
    }

    @Override
    public ResponseEntity<List<MiniHouseModel>> getHouseByHasSeats(String reqParam) {
        houseRepository.setKey(utilWords.getBooleanParamKey().get("hasSeats"));
        return getListResponseEntity(reqParam);
    }
